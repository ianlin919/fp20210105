        ...
        calendarview.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(CalendarView view, int year, int month, int dayOfMonth) {
                ...
                Cursor c;
                    ...
                    c = dbep.rawQuery("SELECT * FROM myTable WHERE year ='" + year + "' and month = '" + month + "' and day ='" + dayOfMonth + "'", null);
                    c.moveToFirst();
                    items.clear();
                    for (int i = 0; i < c.getCount(); i++) {
                    ...
                    c = dbic.rawQuery("SELECT * FROM myTable WHERE year ='" + year + "' and month = '" + month + "' and day ='" + dayOfMonth + "'", null);
                    c.moveToFirst();
                    items.clear();
                    for (int i = 0; i < c.getCount(); i++) {
